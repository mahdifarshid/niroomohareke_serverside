...
<form method="post" enctype="multipart/form-data">
    <script> var product_id ={{$products->first()->id}}</script>
            ...
            <div>
                <div class="bd-highlight" style="direction: rtl;margin-right: 8px;float: right;padding: 10px">
                    ...
                    <p style="display:inline;text-align: right;margin: 15px 5px"
                       id="p_cat">@if(isset($products->first()->cat_name)){{$products->first()->cat_name}}@endif</p>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="demo col-lg-6" style="padding:10px 100px">
                            ...
                            @include('post.ajax.ajaxeditpost')
                            <script>
                        ...
                        <div class="col-lg-6" style="text-align: right;">
                            ...
                            @if(isset($_GET['p']))
                                <div class="alert alert-success">
                                    <a href="{{url('post/showpost/'.$_GET['p'])}}">شما محصول ویرایش شده را میتوانید با
                                        این لینک ببینید</a>
                                </div>
                            @endif
                            ...
                            @foreach($attributes as $attr)
                                ...
                                @foreach($attr['Attr_val'] as $val)
                                    <div class="d-flex bd-highlight">
                                        <input type="hidden" name="attr_product_id[]"
                                               value="{{$val['attr_product_id']}}">
                            ...
                            @if(isset($products->first()->thumb))
                                <?php $image = url('images/products/thumb/' . $products->first()->thumb);?>
                            @else
                                <?php $image = "";?>
                            @endif
                            <img id="imgshowprimary" src="{{$image}}" alt=""
                                 style="width: 60%;float: right;margin-top: 20px">

                            <button class="btn btn-danger" formaction="{{url('/post/edit')}}" type="submit"
                                    style="padding:12px 20px;width:250px;margin: 20px">ویرایش محصول
                            </button>
                            {{--</form>--}}
                        </div>
                        <script>
